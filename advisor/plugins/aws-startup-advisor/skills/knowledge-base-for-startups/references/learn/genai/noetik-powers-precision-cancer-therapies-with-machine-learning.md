...
"One of the core reasons why we chose to work with AWS is the breadth of AWS services and the AWS cloud infrastructure that allowed us to build very quickly," says Alfa. "We were a very small team at the start with significant data needs. We had to build the infrastructure to process all those data sets very quickly. AWS allows us to do that."
