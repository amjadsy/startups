...
- **OpenAI usage API** (for AI workloads on OpenAI): an OpenAI **Admin** API key with the read-only `api.usage.read` scope — read-only, consent-gated capture of real cost and token usage (see `references/phases/discover/discover-openai-api.md`); replaces manual billing CSV exports for OpenAI spend
...
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| **Discover** | `.tf` files, app source code, billing exports, and/or OpenAI Admin API access (at least one required)                                                                    | `gcp-resource-inventory.json`, `gcp-resource-clusters.json`, `ai-workload-profile.json`, `billing-profile.json`, `openai-usage-profile.json`, `.phase-status.json` updated (outputs vary by input)                                            | `references/phases/discover/discover.md` |
